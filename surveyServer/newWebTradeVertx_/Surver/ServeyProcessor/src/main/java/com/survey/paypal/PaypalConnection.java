...
import com.survey.paypal.utils.OrderBean;
...
public class PaypalConnection {
	private PaypalConnection instance = null;
	private Vertx vertx;
	...
	public PaypalConnection getInstance() {

		return instance;
	}

	private void init(JsonObject config, Vertx pVertx) {
		this.config = config;
