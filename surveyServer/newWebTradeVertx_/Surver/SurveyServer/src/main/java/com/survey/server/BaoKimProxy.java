...
public class BaoKimProxy extends AbstractVerticle {
	private String baokim_url = "https://www.baokim.vn/payment/customize_payment/order";

	// Mã merchante site
	private String merchant_id = "34485"; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private String secure_pass = "4089c9ed646eb164"; // Biến này được baokim.vn cung cấp khi bạn đăng
														// ký merchant site
